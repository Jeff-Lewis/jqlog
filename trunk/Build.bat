...
COPY jquery.jqlog.js /B + jqlog.levels.js /B + jqlog.console.js /B Build\jquery.jqlog.custom-%version%.js
...
java -jar yuicompressor-2.4.2.jar Build\jquery.jqlog.custom-%version%.js -o Build\jquery.jqlog.custom-%version%.min.js -v